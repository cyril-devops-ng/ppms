...
<head>
   <meta charset="utf-8" />
   <title>PPMS SAP Transporters</title>
                       ...
                       <li class="pull-right search-wrap">
                           <form action="search" class="hidden-phone">
                               <div class="input-append search-input-area">
                                   <input class="" id="appendedInputButton" type="text" placeholder="Search Transporter">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Transporters</h4>
                            <span class="tools">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">SAP Transporter Number</th>
                                <th class="hidden-phone">SAP Transporter Name</th>
...
$("body").addClass("loading");  
       ...
       function fetchCustomers(){
           $.getJSON('json/sapr3/transporters.json' , function(key,value){
...
//                                '<td><input type="checkbox" class="checkboxes" value="1" /></td>'+
                                '<td>'+(i+1)+'</td>'+
                                '<td class="hidden-phone"><img src="img/gastruck.png" width="35px" height="35px">&nbsp;&nbsp;'+custobj.cust_id+'</td>'+
       ...
       $('#loadcustomers').click(function(){
           $('#preloader').show();
           $.post('saptransporters',{'transporters':'all'},function(msg,stat,xhr){
               if(xhr.readyState === 4){
                   if(xhr.status === 200){
                       $('#preloader').hide();
                       $('#accept').show();
                       setTimeout(function(){
                           window.location.href = 'saptransporters';
                       },2000);
                   }
               }
           });
