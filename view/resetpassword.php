                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> PASSWORD RESET </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="form-control span6 tooltips" name="username" data-trigger="hover" data-original-title="Enter Username.">
                                        <?php
                                            foreach($_SESSION['forteusers'] as $k=>$v){
                                                echo '<option>'.$v['username'].'</option>';
...
<!--                            <div class="control-group">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-success" id="reset">Reset</button>
