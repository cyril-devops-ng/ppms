            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Drivers List</h4>
                            <span class="tools">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody id="tableBody">
                             <?php
                                foreach($_SESSION['drivers'] as $k=>$v){
                                    ...
                                    echo '<td class="hidden-phone"><span class="label label-success">Approved</span></td>';
                                    echo '</tr>';
                                }
