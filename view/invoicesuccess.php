...
<body class="fixed-top">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="alert alert-block alert-success fade in">
                    ...
                    <p>
                        Your deliveries have been successfully invoiced in document <span id="inv"></span>
                    </p>
                </div>
   ...
   <script type="text/javascript">
       $(document).ready(function(){
            $.getJSON('json/invoiced.json',function(key,value){
                var invoice = key;
                var inv = JSON.parse($.trim(invoice));
                for(var a in inv){
                    $('#inv').html(inv[a][0]['po_number']);
                }
            });
       });
   </script>
