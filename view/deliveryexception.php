...
<head>
   <meta charset="utf-8" />
   <title>PPMS Delivery Exceptions</title>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <table border="0">
                        <tr>
                            <td>
                                <button class="btn-block btn-success" id="loaddeliveries" style="width:300px;height:50px">RE-LOAD EXCEPTIONS FROM SAP</button>
                    ...
                    <div class="scroll-left">
                            <p><span style="font-size:20px;color:black;">TODAY STATS:</span><span style="font-size:20px;color:red;">VALUE OF EXCEPTION GOODS: &#8358 6,000,000.00</span></p>
                        </div>
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">STATION</th>
                                <th class="hidden-phone">PGI DATE</th>
                                <th class="hidden-phone">DAYS IN TRANSIT</th>
                                <th class="hidden-phone">HOURS IN TRANSIT</th>
   ...
   <script type="text/javascript">
       $(document).ready(function(){
           ...
           $.getJSON('json/delivery_results.json' , function(key,value){
               ...
               var td = todaydate.substring(4,6)+ "/" + todaydate.substring(6,8) + "/" + todaydate.substring(0,4)  ;
               for(var d in delv){
                   for(var i=0;i<delv[d].length;i++){
                       ...
                       if(delvobj.matnr == '000000000000000001'){
                        ...
                        if( delvobj.pod_time.toString() === '000000' ){
                            //has not be pod'd
                            pgidate = delvobj.pgi_date.toString().substring(4,6)+ "/"+
                                    delvobj.pgi_date.toString().substring(6,8)+ "/"+
                                    delvobj.pgi_date.toString().substring(0,4);
                            
                            var date1 = new Date(pgidate);
                            ...
                            if( diffDays > 2 ){
                               ...
                               delvlist += '<tr class="odd gradeX">'+
                                ...
                                '<td style="background-color: #dc5d3a;color:white;width:150px"><a class="delv" href="#'+delvobj.vbeln+'"><span style="color:white;font-weight: bold;">'+delvobj.vbeln+'</span></a></td>'+
                                '<td class="hidden-phone">'+img+'</td>'+
                                '<td class="hidden-phone">'+delvobj.cust_name+'</td>'+
                                '<td class="hidden-phone">'+delvobj.pgi_date+'</td>'+
                                '<td class="hidden-phone">'+diffDays+' days</td>'+
                                '<td class="hidden-phone">'+Math.round( diffDays * 24 )+' hours</td>'+
                                //'<td class="hidden-phone">'+time.substring(0,2)+':'+time.substring(2,4)+'</td>'+
                                '<td class="hidden-phone"><img src="img/reject.png" width="30px" height="30px"></td>'+
                                '</tr>'; 
                            }
                ...
                function(msg,stat,xhr){
                    if(xhr.readyState === 4){
                        if(xhr.status === 200){
                            ...
                            $('#accept').show();
                            setTimeout(function(){
                                window.location.href = 'deliveryexception';
                            },2000);
                        }else{
                            $('#preloader').hide();
                         }
