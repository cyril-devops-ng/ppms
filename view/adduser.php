                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> USER REGISTRATION </h4>
                            <span class="tools">
...
<!--                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select id="category" name="userCategory" class="span6 " data-placeholder="Choose a Category" tabindex="1">
                            ...
                            <div class="control-group" id="sapcategory">
                                <label id="saplabel" class="control-label">SAP</label>
                                <div class="controls">
                                    <input type="text" name="sap" list="sap">
                                    <datalist id="sap">
                                    </datalist>
   ...
   <script type="text/javascript">
       $(document).ready(function(){
        ...
        function fetchDepotStaff(){
            $('#sap').html('');
            var _c = '';
            _c += '<option>Customer Service</option>';
            _c += '<option>Administrator</option>';
        ...
        $('#category').on('change',function(){
            var value = $(this).val();
            if( value === 'Station Manager/Rep'){
                $('#sapcategory').slideDown('slow');
                $('#saplabel').html('Customer');
                fetchCustomers();
            }
            if( value === 'Transporter'){
                $('#sapcategory').slideDown('slow');
                $('#saplabel').html('Transporter');
                fetchTransporters();
            }
            if(value === 'Depot Staff'){
                $('#sapcategory').slideDown('slow');
                $('#saplabel').html('Role');
                fetchDepotStaff();
             }
