...
<head>
   <meta charset="utf-8" />
   <title>PPMS Deliveries Per Zone</title>
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">HEADING FROM</th>
                                <th class="hidden-phone">HEADED TO</th>
                       ...
                       var time = delvobj.pod_time.toString();
                        ...
                        if( delvobj.pod_time.toString() === '000000' ){
                            delvlist += '<tr class="odd gradeX">'+
                                ...
                                '<td class="hidden-phone">'+delvobj.headedfrom+'</td>'+
                                '<td class="hidden-phone">'+delvobj.headed_to+'</td>'+
                                '<td class="hidden-phone">'+delvobj.route+'</td>'+
                                '<td class="hidden-phone">'+delvobj.zone+'</td>'+
                ...
                function(msg,stat,xhr){
                    if(xhr.readyState === 4){
                        if(xhr.status === 200){
                            ...
                            $('#accept').show();
                            setTimeout(function(){
                                window.location.href = 'deliveriesperzone';
                            },2000);
                        }else{
                            $('#preloader').hide();
                         }
