...
<head>
   <meta charset="utf-8" />
   <title>PPMS User Feedback Report</title>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i>User Feedback Report</h4>
                            <span class="tools">
...
//                       print '<pre>';print_r($_SESSION['ratings']); print '</pre>';
                       ...
                       ?>
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">Satisfaction Rate</th>
                            ...
                            <tbody>
                               ...
                               <?php
                                foreach($_SESSION['ratings'] as $k=>$v){
                                    switch ($v['rate']){
                                        case '1':
                                            $r = 'Poor';break;
                                        case '2':
                                            $r = 'Satisfactory';break;
                                        case '3':
                                            $r = 'Good';break;
                                        case '4':
                                            $r = 'Very Good';break;
                                    ...
                                    echo '<td><a class="delv" href="#800001234">'.$v['delivery'].'</a></td>';
                                    echo '<td><img src="img/station.png" width="25px" height="25px"></td>';
                                    echo '<td>'.$v['username'].'</td>';
                                    echo '<td>GRA Ikeja, Lagos</td>';
                                    echo '<td class="hidden-phone">JOGANA COMPANY NIG LTD</td>';
                                    echo '<td class="hidden-phone">FELIX</td>';
                                    echo '<td class="hidden-phone">'.$r.'</td>';
                                    echo '<td class="hidden-phone"></td>';
                                    echo '</tr>';
                                }
                               ?>
                            </tbody>
