...
<head>
   <meta charset="utf-8" />
   <title>PPMS Invoiced Deliveries</title>
...
//                                               '</tr>';
                                           ...
                                           for(var n=0;n<inv_list.length;n++){
                                            ...
                                            if( f === true){
                                                delvlist += '<tr class="odd gradeX">'+
                                                    '<td><input type="checkbox" class="checkboxes" value="1" /></td>'+
                                                    '<td style="color:black;"><a class="delv" href="#'+delvobj.vbeln+'"><span style="font-weight: bold;text-decoration:none;">'+delvobj.vbeln+'</span></a></td>'+
                                                    '<td class="hidden-phone">'+invno+'&nbsp;&nbsp;<img src="img/good.png" width="20px" height="20px"></td>'+
                                                    '<td class="hidden-phone">'+product+'</td>'+
                                                    ...
                                                    '<td class="hidden-phone"><img src="img/invoice3.jpg" width="35px" height="35px"></td>'+
                                                    '</tr>';
                                            }
                                       }
