...
<head>
   <meta charset="utf-8" />
   <title>PPMS Delivery Report</title>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="scroll-left">
                            <p><span style="font-size:20px;color:black;">TODAY:</span><span style="color:green;font-size: 20px;">VALUE DELIVERED: &#8358 25,000,450.00</span>
                ...
                function(msg,stat,xhr){
                    if(xhr.readyState === 4){
                        if(xhr.status === 200){
                            ...
                            $('#accept').show();
                            setTimeout(function(){
                                window.location.href = 'deliveryreport';
                            },2000);
                        }else{
                            $('#preloader').hide();
                         }
