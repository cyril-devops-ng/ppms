...
<head>
   <meta charset="utf-8" />
   <title>PPMS Create Invoice</title>
                 ...
                 <div class="span12">
                     ...
                     <div class="widget green">
                         <div class="widget-title">
                             <h4><i class="icon-edit"></i> Process Invoice for Deliveries </h4>
                           <span class="tools">
                         ...
                         <div>
                             <br>
                             <center><button class="btn-success btn btn-lg" style="height:60px;" id="generateInvoice">GENERATE INVOICE</button></center>;
...
//                                               '</tr>';
                                           ...
                                           for(var n=0;n<inv_list.length;n++){
                                            ...
                                            if( f === false){
                                                delvlist += '<tr class="odd gradeX invoiceList">'+
                                                    '<td><input type="checkbox" class="checkboxes" value="'+delvobj.vbeln+'" /></td>'+
           ...
           $('#generateInvoice').click(function(){
                $('.checkboxes').each(function(){
                    if($(this).is(':checked')){
                        ...
                        window.localStorage.setItem('invoice',deliveries);
